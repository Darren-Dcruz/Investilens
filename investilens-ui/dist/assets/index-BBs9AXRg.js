 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(F,Z){var P=F.length;F.push(Z);e:for(;0<P;){var C=P-1>>>1,V=F[C];if(0<r(V,Z))F[C]=Z,F[P]=V,P=C;else break e}}function n(F){return F.length===0?null:F[0]}function i(F){if(F.length===0)return null;var Z=F[0],P=F.pop();if(P!==Z){F[0]=P;e:for(var C=0,V=F.length,ae=V>>>1;C<ae;){var oe=2*(C+1)-1,se=F[oe],H=oe+1,J=F[H];if(0>r(se,P))H<V&&0>r(J,se)?(F[C]=J,F[H]=P,C=H):(F[C]=se,F[oe]=P,C=oe);else if(H<V&&0>r(J,P))F[C]=J,F[H]=P,C=H;else break e}}return Z}function r(F,Z){var P=F.sortIndex-Z.sortIndex;return P!==0?P:F.id-Z.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var a=Date,o=a.now();t.unstable_now=function(){return a.now()-o}}var l=[],c=[],p=1,m=null,u=3,f=!1,y=!1,E=!1,x=typeof setTimeout=="function"?setTimeout:null,d=typeof clearTimeout=="function"?clearTimeout:null,g=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function v(F){for(var Z=n(c);Z!==null;){if(Z.callback===null)i(c);else if(Z.startTime<=F)i(c),Z.sortIndex=Z.expirationTime,e(l,Z);else break;Z=n(c)}}function M(F){if(E=!1,v(F),!y)if(n(l)!==null)y=!0,Y(T);else{var Z=n(c);Z!==null&&W(M,Z.startTime-F)}}function T(F,Z){y=!1,E&&(E=!1,d(_),_=-1),f=!0;var P=u;try{for(v(Z),m=n(l);m!==null&&(!(m.expirationTime>Z)||F&&!L());){var C=m.callback;if(typeof C=="function"){m.callback=null,u=m.priorityLevel;var V=C(m.expirationTime<=Z);Z=t.unstable_now(),typeof V=="function"?m.callback=V:m===n(l)&&i(l),v(Z)}else i(l);m=n(l)}if(m!==null)var ae=!0;else{var oe=n(c);oe!==null&&W(M,oe.startTime-Z),ae=!1}return ae}finally{m=null,u=P,f=!1}}var w=!1,R=null,_=-1,A=5,I=-1;function L(){return!(t.unstable_now()-I<A)}function B(){if(R!==null){var F=t.unstable_now();I=F;var Z=!0;try{Z=R(!0,F)}finally{Z?G():(w=!1,R=null)}}else w=!1}var G;if(typeof g=="function")G=function(){g(B)};else if(typeof MessageChannel<"u"){var Q=new MessageChannel,k=Q.port2;Q.port1.onmessage=B,G=function(){k.postMessage(null)}}else G=function(){x(B,0)};function Y(F){R=F,w||(w=!0,G())}function W(F,Z){_=x(function(){F(t.unstable_now())},Z)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(F){F.callback=null},t.unstable_continueExecution=function(){y||f||(y=!0,Y(T))},t.unstable_forceFrameRate=function(F){0>F||125<F?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):A=0<F?Math.floor(1e3/F):5},t.unstable_getCurrentPriorityLevel=function(){return u},t.unstable_getFirstCallbackNode=function(){return n(l)},t.unstable_next=function(F){switch(u){case 1:case 2:case 3:var Z=3;break;default:Z=u}var P=u;u=Z;try{return F()}finally{u=P}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(F,Z){switch(F){case 1:case 2:case 3:case 4:case 5:break;default:F=3}var P=u;u=F;try{return Z()}finally{u=P}},t.unstable_scheduleCallback=function(F,Z,P){var C=t.unstable_now();switch(typeof P=="object"&&P!==null?(P=P.delay,P=typeof P=="number"&&0<P?C+P:C):P=C,F){case 1:var V=-1;break;case 2:V=250;break;case 5:V=1073741823;break;case 4:V=1e4;break;default:V=5e3}return V=P+V,F={id:p++,callback:Z,priorityLevel:F,startTime:P,expirationTime:V,sortIndex:-1},P>C?(F.sortIndex=P,e(c,F),n(l)===null&&F===n(c)&&(E?(d(_),_=-1):E=!0,W(M,P-C))):(F.sortIndex=V,e(l,F),y||f||(y=!0,Y(T))),F},t.unstable_shouldYield=L,t.unstable_wrapCallback=function(F){var Z=u;return function(){var P=u;u=Z;try{return F.apply(this,arguments)}finally{u=P}}}})(Wm);Gm.exports=Wm;var hv=Gm.exports;/**
 * @license React
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const yy=Be.forwardRef(({color:t="currentColor",size:e=24,strokeWidth:n=2,absoluteStrokeWidth:i,className:r="",children:s,iconNode:a,...o},l)=>Be.createElement("svg",{ref:l,..._y,width:e,height:e,stroke:t,strokeWidth:i?Number(n)*24/Number(e):n,className:Gg("lucide",r),...o},[...a.map(([c,p])=>Be.createElement(c,p)),...Array.isArray(s)?s:[s]]));/**
 * @license lucide-react v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const rt=(t,e)=>{const n=Be.forwardRef(({className:i,...r},s)=>Be.createElement(yy,{ref:s,iconNode:e,className:Gg(`lucide-${vy(t)}`,i),...r}));return n.displayName=`${t}`,n};/**
 * @license lucide-react v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ay=[["path",{d:"M20 6 9 17l-5-5",key:"1gmf2c"}]],Wg=rt("Check",Ay);/**
 * @license lucide-react v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ny=[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"m9 12 2 2 4-4",key:"dzmm74"}]],jg=rt("CircleCheck",Ny);/**
 * @license lucide-react v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Py=[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3",key:"1u773s"}],["path",{d:"M12 17h.01",key:"p32p05"}]],Xg=rt("CircleHelp",Py);/**
 * @license lucide-react v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Oy=[["rect",{width:"16",height:"16",x:"4",y:"4",rx:"2",key:"14l7u7"}],["rect",{width:"6",height:"6",x:"9",y:"9",rx:"1",key:"5aljv4"}],["path",{d:"M15 2v2",key:"13l42r"}],["path",{d:"M15 20v2",key:"15mkzm"}],["path",{d:"M2 15h2",key:"1gxd5l"}],["path",{d:"M2 9h2",key:"1bbxkp"}],["path",{d:"M20 15h2",key:"19e6y8"}],["path",{d:"M20 9h2",key:"19tzq7"}],["path",{d:"M9 2v2",key:"165o2o"}],["path",{d:"M9 20v2",key:"i2bqo8"}]],qg=rt("Cpu",Oy);/**
 * @license lucide-react v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const By=[["ellipse",{cx:"12",cy:"5",rx:"9",ry:"3",key:"msslwz"}],["path",{d:"M3 5V19A9 3 0 0 0 21 19V5",key:"1wlel7"}],["path",{d:"M3 12A9 3 0 0 0 21 12",key:"mv7ke4"}]],$g=rt("Database",By);/**
 * @license lucide-react v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Vy=[["path",{d:"M21 12a9 9 0 1 1-6.219-8.56",key:"13zald"}]],Hy=rt("LoaderCircle",Vy);/**
 * @license lucide-react v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Gy=[["path",{d:"M12 20h9",key:"t2du7b"}],["path",{d:"M16.376 3.622a1 1 0 0 1 3.002 3.002L7.368 18.635a2 2 0 0 1-.855.506l-2.872.838a.5.5 0 0 1-.62-.62l.838-2.872a2 2 0 0 1 .506-.854z",key:"1ykcvy"}]],Yg=rt("PenLine",Gy);/**
 * @license lucide-react v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const $y=[["path",{d:"m16 16 3-8 3 8c-.87.65-1.92 1-3 1s-2.13-.35-3-1Z",key:"7g6ntu"}],["path",{d:"m2 16 3-8 3 8c-.87.65-1.92 1-3 1s-2.13-.35-3-1Z",key:"ijws7r"}],["path",{d:"M7 21h10",key:"1b0cd5"}],["path",{d:"M12 3v18",key:"108xh3"}],["path",{d:"M3 7h2c2 0 5-1 7-2 2 1 5 2 7 2h2",key:"3gwbw2"}]],Kg=rt("Scale",$y);/**
 * @license lucide-react v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const cS=[["path",{d:"m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3",key:"wmoenq"}],["path",{d:"M12 9v4",key:"juzpu7"}],["path",{d:"M12 17h.01",key:"p32p05"}]],Zg=rt("TriangleAlert",cS);/**
 * @license lucide-react v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
...
`)}const Iw={[Jg]:"Linear",[ex]:"Reinhard",[tx]:"Cineon",[nx]:"ACESFilmic",[rx]:"AgX",[sx]:"Neutral",[ix]:"Custom"};function Lw(t,e){const n=Iw[e];return n===void 0?(Oe("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+t+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+t+"( vec3 color ) { return "+n+"ToneMapping( color ); }"}const ko=new j;function Dw(){$e.getLuminanceCoefficients(ko);const t=ko.x.toFixed(4),e=ko.y.toFixed(4),n=ko.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${t}, ${e}, ${n} );`,"	return dot( weights, rgb );","}"].join(`
...
`)+`
`+d);const v=g+x+a,M=g+d+o,T=_m(r,r.VERTEX_SHADER,v),w=_m(r,r.FRAGMENT_SHADER,M);r.attachShader(E,T),r.attachShader(E,w),n.index0AttributeName!==void 0?r.bindAttribLocation(E,0,n.index0AttributeName):n.hasPositionAttribute===!0&&r.bindAttribLocation(E,0,"position"),r.linkProgram(E);function R(L){if(t.debug.checkShaderErrors){const B=r.getProgramInfoLog(E)||"",G=r.getShaderInfoLog(T)||"",Q=r.getShaderInfoLog(w)||"",k=B.trim(),Y=G.trim(),W=Q.trim();let F=!0,Z=!0;if(r.getProgramParameter(E,r.LINK_STATUS)===!1)if(F=!1,typeof t.debug.onShaderError=="function")t.debug.onShaderError(r,E,T,w);else{const P=Sm(r,T,"vertex"),C=Sm(r,w,"fragment");et("WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(E,r.VALIDATE_STATUS)+`
...
}`,mT=[new j(1,0,0),new j(-1,0,0),new j(0,1,0),new j(0,-1,0),new j(0,0,1),new j(0,0,-1)],gT=[new j(0,-1,0),new j(0,-1,0),new j(0,0,1),new j(0,0,-1),new j(0,-1,0),new j(0,-1,0)],Rm=new Pt,na=new j,cu=new j;function xT(t,e,n){let i=new Sx;const r=new Qe,s=new Qe,a=new At,o=new NM,l=new PM,c={},p=n.maxTextureSize,m={[cr]:pn,[pn]:cr,[Si]:Si},u=new hi({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Qe},radius:{value:4}},vertexShader:hT,fragmentShader:pT}),f=u.clone();f.defines.HORIZONTAL_PASS=1;const y=new wn;y.setAttribute("position",new Un(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const E=new Fn(y,u),x=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Ko;let d=this.type;this.render=function(w,R,_){if(x.enabled===!1||x.autoUpdate===!1&&x.needsUpdate===!1||w.length===0)return;this.type===vS&&(Oe("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=Ko);const A=t.getRenderTarget(),I=t.getActiveCubeFace(),L=t.getActiveMipmapLevel(),B=t.state;B.setBlending(Ti),B.buffers.depth.getReversed()===!0?B.buffers.color.setClear(0,0,0,0):B.buffers.color.setClear(1,1,1,1),B.buffers.depth.setTest(!0),B.setScissorTest(!1);const G=d!==this.type;G&&R.traverse(function(Q){Q.material&&(Array.isArray(Q.material)?Q.material.forEach(k=>k.needsUpdate=!0):Q.material.needsUpdate=!0)});for(let Q=0,k=w.length;Q<k;Q++){const Y=w[Q],W=Y.shadow;if(W===void 0){Oe("WebGLShadowMap:",Y,"has no shadow.");continue}if(W.autoUpdate===!1&&W.needsUpdate===!1)continue;r.copy(W.mapSize);const F=W.getFrameExtents();r.multiply(F),s.copy(W.mapSize),(r.x>p||r.y>p)&&(r.x>p&&(s.x=Math.floor(p/F.x),r.x=s.x*F.x,W.mapSize.x=s.x),r.y>p&&(s.y=Math.floor(p/F.y),r.y=s.y*F.y,W.mapSize.y=s.y));const Z=t.state.buffers.depth.getReversed();if(W.camera._reversedDepth=Z,W.map===null||G===!0){if(W.map!==null&&(W.map.depthTexture!==null&&(W.map.depthTexture.dispose(),W.map.depthTexture=null),W.map.dispose()),this.type===oa){if(Y.isPointLight){Oe("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}W.map=new di(r.x,r.y,{format:Fr,type:Ii,minFilter:Qt,magFilter:Qt,generateMipmaps:!1}),W.map.texture.name=Y.name+".shadowMap",W.map.depthTexture=new Us(r.x,r.y,ai),W.map.depthTexture.name=Y.name+".shadowMapDepth",W.map.depthTexture.format=Li,W.map.depthTexture.compareFunction=null,W.map.depthTexture.minFilter=Gt,W.map.depthTexture.magFilter=Gt}else Y.isPointLight?(W.map=new Nx(r.x),W.map.depthTexture=new bM(r.x,fi)):(W.map=new di(r.x,r.y),W.map.depthTexture=new Us(r.x,r.y,fi)),W.map.depthTexture.name=Y.name+".shadowMap",W.map.depthTexture.format=Li,this.type===Ko?(W.map.depthTexture.compareFunction=Z?ih:nh,W.map.depthTexture.minFilter=Qt,W.map.depthTexture.magFilter=Qt):(W.map.depthTexture.compareFunction=null,W.map.depthTexture.minFilter=Gt,W.map.depthTexture.magFilter=Gt);W.camera.updateProjectionMatrix()}const P=W.map.isWebGLCubeRenderTarget?6:1;for(let C=0;C<P;C++){if(W.map.isWebGLCubeRenderTarget)t.setRenderTarget(W.map,C),t.clear();else{C===0&&(t.setRenderTarget(W.map),t.clear());const V=W.getViewport(C);a.set(s.x*V.x,s.y*V.y,s.x*V.z,s.y*V.w),B.viewport(a)}if(Y.isPointLight){const V=W.camera,ae=W.matrix,oe=Y.distance||V.far;oe!==V.far&&(V.far=oe,V.updateProjectionMatrix()),na.setFromMatrixPosition(Y.matrixWorld),V.position.copy(na),cu.copy(V.position),cu.add(mT[C]),V.up.copy(gT[C]),V.lookAt(cu),V.updateMatrixWorld(),ae.makeTranslation(-na.x,-na.y,-na.z),Rm.multiplyMatrices(V.projectionMatrix,V.matrixWorldInverse),W._frustum.setFromProjectionMatrix(Rm,V.coordinateSystem,V.reversedDepth)}else W.updateMatrices(Y);i=W.getFrustum(),M(R,_,W.camera,Y,this.type)}W.isPointLightShadow!==!0&&this.type===oa&&g(W,_),W.needsUpdate=!1}d=this.type,x.needsUpdate=!1,t.setRenderTarget(A,I,L)};function g(w,R){const _=e.update(E);u.defines.VSM_SAMPLES!==w.blurSamples&&(u.defines.VSM_SAMPLES=w.blurSamples,f.defines.VSM_SAMPLES=w.blurSamples,u.needsUpdate=!0,f.needsUpdate=!0),w.mapPass===null&&(w.mapPass=new di(r.x,r.y,{format:Fr,type:Ii})),u.uniforms.shadow_pass.value=w.map.depthTexture,u.uniforms.resolution.value=w.mapSize,u.uniforms.radius.value=w.radius,t.setRenderTarget(w.mapPass),t.clear(),t.renderBufferDirect(R,null,_,u,E,null),f.uniforms.shadow_pass.value=w.mapPass.texture,f.uniforms.resolution.value=w.mapSize,f.uniforms.radius.value=w.radius,t.setRenderTarget(w.map),t.clear(),t.renderBufferDirect(R,null,_,f,E,null)}function v(w,R,_,A){let I=null;const L=_.isPointLight===!0?w.customDistanceMaterial:w.customDepthMaterial;if(L!==void 0)I=L;else if(I=_.isPointLight===!0?l:o,t.localClippingEnabled&&R.clipShadows===!0&&Array.isArray(R.clippingPlanes)&&R.clippingPlanes.length!==0||R.displacementMap&&R.displacementScale!==0||R.alphaMap&&R.alphaTest>0||R.map&&R.alphaTest>0||R.alphaToCoverage===!0){const B=I.uuid,G=R.uuid;let Q=c[B];Q===void 0&&(Q={},c[B]=Q);let k=Q[G];k===void 0&&(k=I.clone(),Q[G]=k,R.addEventListener("dispose",T)),I=k}if(I.visible=R.visible,I.wireframe=R.wireframe,A===oa?I.side=R.shadowSide!==null?R.shadowSide:R.side:I.side=R.shadowSide!==null?R.shadowSide:m[R.side],I.alphaMap=R.alphaMap,I.alphaTest=R.alphaToCoverage===!0?.5:R.alphaTest,I.map=R.map,I.clipShadows=R.clipShadows,I.clippingPlanes=R.clippingPlanes,I.clipIntersection=R.clipIntersection,I.displacementMap=R.displacementMap,I.displacementScale=R.displacementScale,I.displacementBias=R.displacementBias,I.wireframeLinewidth=R.wireframeLinewidth,I.linewidth=R.linewidth,_.isPointLight===!0&&I.isMeshDistanceMaterial===!0){const B=t.properties.get(I);B.light=_}return I}function M(w,R,_,A,I){if(w.visible===!1)return;if(w.layers.test(R.layers)&&(w.isMesh||w.isLine||w.isPoints)&&(w.castShadow||w.receiveShadow&&I===oa)&&(!w.frustumCulled||i.intersectsObject(w))){w.modelViewMatrix.multiplyMatrices(_.matrixWorldInverse,w.matrixWorld);const G=e.update(w),Q=w.material;if(Array.isArray(Q)){const k=G.groups;for(let Y=0,W=k.length;Y<W;Y++){const F=k[Y],Z=Q[F.materialIndex];if(Z&&Z.visible){const P=v(w,Z,A,I);w.onBeforeShadow(t,w,R,_,G,P,F),t.renderBufferDirect(_,null,G,P,w,F),w.onAfterShadow(t,w,R,_,G,P,F)}}}else if(Q.visible){const k=v(w,Q,A,I);w.onBeforeShadow(t,w,R,_,G,k,null),t.renderBufferDirect(_,null,G,k,w,null),w.onAfterShadow(t,w,R,_,G,k,null)}}const B=w.children;for(let G=0,Q=B.length;G<Q;G++)M(B[G],R,_,A,I)}function T(w){w.target.removeEventListener("dispose",T);for(const _ in c){const A=c[_],I=w.target.uuid;I in A&&(A[I].dispose(),delete A[I])}}}function vT(t,e){function n(){let D=!1;const he=new At;let ie=null;const xe=new At(0,0,0,0);return{setMask:function(be){ie!==be&&!D&&(t.colorMask(be,be,be,be),ie=be)},setLocked:function(be){D=be},setClear:function(be,le,Ie,Ne,bt){bt===!0&&(be*=Ne,le*=Ne,Ie*=Ne),he.set(be,le,Ie,Ne),xe.equals(he)===!1&&(t.clearColor(be,le,Ie,Ne),xe.copy(he))},reset:function(){D=!1,ie=null,xe.set(-1,0,0,0)}}}function i(){let D=!1,he=!1,ie=null,xe=null,be=null;return{setReversed:function(le){if(he!==le){const Ie=e.get("EXT_clip_control");le?Ie.clipControlEXT(Ie.LOWER_LEFT_EXT,Ie.ZERO_TO_ONE_EXT):Ie.clipControlEXT(Ie.LOWER_LEFT_EXT,Ie.NEGATIVE_ONE_TO_ONE_EXT),he=le;const Ne=be;be=null,this.setClear(Ne)}},getReversed:function(){return he},setTest:function(le){le?ee(t.DEPTH_TEST):pe(t.DEPTH_TEST)},setMask:function(le){ie!==le&&!D&&(t.depthMask(le),ie=le)},setFunc:function(le){if(he&&(le=ZS[le]),xe!==le){switch(le){case od:t.depthFunc(t.NEVER);break;case ld:t.depthFunc(t.ALWAYS);break;case cd:t.depthFunc(t.LESS);break;case Ls:t.depthFunc(t.LEQUAL);break;case ud:t.depthFunc(t.EQUAL);break;case dd:t.depthFunc(t.GEQUAL);break;case fd:t.depthFunc(t.GREATER);break;case hd:t.depthFunc(t.NOTEQUAL);break;default:t.depthFunc(t.LEQUAL)}xe=le}},setLocked:function(le){D=le},setClear:function(le){be!==le&&(be=le,he&&(le=1-le),t.clearDepth(le))},reset:function(){D=!1,ie=null,xe=null,be=null,he=!1}}}function r(){let D=!1,he=null,ie=null,xe=null,be=null,le=null,Ie=null,Ne=null,bt=null;return{setTest:function(ht){D||(ht?ee(t.STENCIL_TEST):pe(t.STENCIL_TEST))},setMask:function(ht){he!==ht&&!D&&(t.stencilMask(ht),he=ht)},setFunc:function(ht,Zn,Qn){(ie!==ht||xe!==Zn||be!==Qn)&&(t.stencilFunc(ht,Zn,Qn),ie=ht,xe=Zn,be=Qn)},setOp:function(ht,Zn,Qn){(le!==ht||Ie!==Zn||Ne!==Qn)&&(t.stencilOp(ht,Zn,Qn),le=ht,Ie=Zn,Ne=Qn)},setLocked:function(ht){D=ht},setClear:function(ht){bt!==ht&&(t.clearStencil(ht),bt=ht)},reset:function(){D=!1,he=null,ie=null,xe=null,be=null,le=null,Ie=null,Ne=null,bt=null}}}const s=new n,a=new i,o=new r,l=new WeakMap,c=new WeakMap;let p={},m={},u={},f=new WeakMap,y=[],E=null,x=!1,d=null,g=null,v=null,M=null,T=null,w=null,R=null,_=new Ze(0,0,0),A=0,I=!1,L=null,B=null,G=null,Q=null,k=null;const Y=t.getParameter(t.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let W=!1,F=0;const Z=t.getParameter(t.VERSION);Z.indexOf("WebGL")!==-1?(F=parseFloat(/^WebGL (\d)/.exec(Z)[1]),W=F>=1):Z.indexOf("OpenGL ES")!==-1&&(F=parseFloat(/^OpenGL ES (\d)/.exec(Z)[1]),W=F>=2);let P=null,C={};const V=t.getParameter(t.SCISSOR_BOX),ae=t.getParameter(t.VIEWPORT),oe=new At().fromArray(V),se=new At().fromArray(ae);function H(D,he,ie,xe){const be=new Uint8Array(4),le=t.createTexture();t.bindTexture(D,le),t.texParameteri(D,t.TEXTURE_MIN_FILTER,t.NEAREST),t.texParameteri(D,t.TEXTURE_MAG_FILTER,t.NEAREST);for(let Ie=0;Ie<ie;Ie++)D===t.TEXTURE_3D||D===t.TEXTURE_2D_ARRAY?t.texImage3D(he,0,t.RGBA,1,1,xe,0,t.RGBA,t.UNSIGNED_BYTE,be):t.texImage2D(he+Ie,0,t.RGBA,1,1,0,t.RGBA,t.UNSIGNED_BYTE,be);return le}const J={};J[t.TEXTURE_2D]=H(t.TEXTURE_2D,t.TEXTURE_2D,1),J[t.TEXTURE_CUBE_MAP]=H(t.TEXTURE_CUBE_MAP,t.TEXTURE_CUBE_MAP_POSITIVE_X,6),J[t.TEXTURE_2D_ARRAY]=H(t.TEXTURE_2D_ARRAY,t.TEXTURE_2D_ARRAY,1,1),J[t.TEXTURE_3D]=H(t.TEXTURE_3D,t.TEXTURE_3D,1,1),s.setClear(0,0,0,1),a.setClear(1),o.setClear(0),ee(t.DEPTH_TEST),a.setFunc(Ls),nt(!1),st(Pp),ee(t.CULL_FACE),ze(Ti);function ee(D){p[D]!==!0&&(t.enable(D),p[D]=!0)}function pe(D){p[D]!==!1&&(t.disable(D),p[D]=!1)}function Ee(D,he){return u[D]!==he?(t.bindFramebuffer(D,he),u[D]=he,D===t.DRAW_FRAMEBUFFER&&(u[t.FRAMEBUFFER]=he),D===t.FRAMEBUFFER&&(u[t.DRAW_FRAMEBUFFER]=he),!0):!1}function fe(D,he){let ie=y,xe=!1;if(D){ie=f.get(he),ie===void 0&&(ie=[],f.set(he,ie));const be=D.textures;if(ie.length!==be.length||ie[0]!==t.COLOR_ATTACHMENT0){for(let le=0,Ie=be.length;le<Ie;le++)ie[le]=t.COLOR_ATTACHMENT0+le;ie.length=be.length,xe=!0}}else ie[0]!==t.BACK&&(ie[0]=t.BACK,xe=!0);xe&&t.drawBuffers(ie)}function ve(D){return E!==D?(t.useProgram(D),E=D,!0):!1}const Re={[Sr]:t.FUNC_ADD,[yS]:t.FUNC_SUBTRACT,[SS]:t.FUNC_REVERSE_SUBTRACT};Re[MS]=t.MIN,Re[ES]=t.MAX;const Ce={[bS]:t.ZERO,[wS]:t.ONE,[TS]:t.SRC_COLOR,[sd]:t.SRC_ALPHA,[IS]:t.SRC_ALPHA_SATURATE,[NS]:t.DST_COLOR,[CS]:t.DST_ALPHA,[AS]:t.ONE_MINUS_SRC_COLOR,[ad]:t.ONE_MINUS_SRC_ALPHA,[PS]:t.ONE_MINUS_DST_COLOR,[RS]:t.ONE_MINUS_DST_ALPHA,[LS]:t.CONSTANT_COLOR,[DS]:t.ONE_MINUS_CONSTANT_COLOR,[US]:t.CONSTANT_ALPHA,[FS]:t.ONE_MINUS_CONSTANT_ALPHA};function ze(D,he,ie,xe,be,le,Ie,Ne,bt,ht){if(D===Ti){x===!0&&(pe(t.BLEND),x=!1);return}if(x===!1&&(ee(t.BLEND),x=!0),D!==_S){if(D!==d||ht!==I){if((g!==Sr||T!==Sr)&&(t.blendEquation(t.FUNC_ADD),g=Sr,T=Sr),ht)switch(D){case Es:t.blendFuncSeparate(t.ONE,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case rd:t.blendFunc(t.ONE,t.ONE);break;case Ip:t.blendFuncSeparate(t.ZERO,t.ONE_MINUS_SRC_COLOR,t.ZERO,t.ONE);break;case Lp:t.blendFuncSeparate(t.DST_COLOR,t.ONE_MINUS_SRC_ALPHA,t.ZERO,t.ONE);break;default:et("WebGLState: Invalid blending: ",D);break}else switch(D){case Es:t.blendFuncSeparate(t.SRC_ALPHA,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case rd:t.blendFuncSeparate(t.SRC_ALPHA,t.ONE,t.ONE,t.ONE);break;case Ip:et("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Lp:et("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:et("WebGLState: Invalid blending: ",D);break}v=null,M=null,w=null,R=null,_.set(0,0,0),A=0,d=D,I=ht}return}be=be||he,le=le||ie,Ie=Ie||xe,(he!==g||be!==T)&&(t.blendEquationSeparate(Re[he],Re[be]),g=he,T=be),(ie!==v||xe!==M||le!==w||Ie!==R)&&(t.blendFuncSeparate(Ce[ie],Ce[xe],Ce[le],Ce[Ie]),v=ie,M=xe,w=le,R=Ie),(Ne.equals(_)===!1||bt!==A)&&(t.blendColor(Ne.r,Ne.g,Ne.b,bt),_.copy(Ne),A=bt),d=D,I=!1}function Ve(D,he){D.side===Si?pe(t.CULL_FACE):ee(t.CULL_FACE);let ie=D.side===pn;he&&(ie=!ie),nt(ie),D.blending===Es&&D.transparent===!1?ze(Ti):ze(D.blending,D.blendEquation,D.blendSrc,D.blendDst,D.blendEquationAlpha,D.blendSrcAlpha,D.blendDstAlpha,D.blendColor,D.blendAlpha,D.premultipliedAlpha),a.setFunc(D.depthFunc),a.setTest(D.depthTest),a.setMask(D.depthWrite),s.setMask(D.colorWrite);const xe=D.stencilWrite;o.setTest(xe),xe&&(o.setMask(D.stencilWriteMask),o.setFunc(D.stencilFunc,D.stencilRef,D.stencilFuncMask),o.setOp(D.stencilFail,D.stencilZFail,D.stencilZPass)),lt(D.polygonOffset,D.polygonOffsetFactor,D.polygonOffsetUnits),D.alphaToCoverage===!0?ee(t.SAMPLE_ALPHA_TO_COVERAGE):pe(t.SAMPLE_ALPHA_TO_COVERAGE)}function nt(D){L!==D&&(D?t.frontFace(t.CW):t.frontFace(t.CCW),L=D)}function st(D){D!==gS?(ee(t.CULL_FACE),D!==B&&(D===Pp?t.cullFace(t.BACK):D===xS?t.cullFace(t.FRONT):t.cullFace(t.FRONT_AND_BACK))):pe(t.CULL_FACE),B=D}function ft(D){D!==G&&(W&&t.lineWidth(D),G=D)}function lt(D,he,ie){D?(ee(t.POLYGON_OFFSET_FILL),(Q!==he||k!==ie)&&(Q=he,k=ie,a.getReversed()&&(he=-he),t.polygonOffset(he,ie))):pe(t.POLYGON_OFFSET_FILL)}function vt(D){D?ee(t.SCISSOR_TEST):pe(t.SCISSOR_TEST)}function Et(D){D===void 0&&(D=t.TEXTURE0+Y-1),P!==D&&(t.activeTexture(D),P=D)}function U(D,he,ie){ie===void 0&&(P===null?ie=t.TEXTURE0+Y-1:ie=P);let xe=C[ie];xe===void 0&&(xe={type:void 0,texture:void 0},C[ie]=xe),(xe.type!==D||xe.texture!==he)&&(P!==ie&&(t.activeTexture(ie),P=ie),t.bindTexture(D,he||J[D]),xe.type=D,xe.texture=he)}function Vt(){const D=C[P];D!==void 0&&D.type!==void 0&&(t.bindTexture(D.type,null),D.type=void 0,D.texture=void 0)}function it(){try{t.compressedTexImage2D(...arguments)}catch(D){et("WebGLState:",D)}}function N(){try{t.compressedTexImage3D(...arguments)}catch(D){et("WebGLState:",D)}}function S(){try{t.texSubImage2D(...arguments)}catch(D){et("WebGLState:",D)}}function z(){try{t.texSubImage3D(...arguments)}catch(D){et("WebGLState:",D)}}function $(){try{t.compressedTexSubImage2D(...arguments)}catch(D){et("WebGLState:",D)}}function te(){try{t.compressedTexSubImage3D(...arguments)}catch(D){et("WebGLState:",D)}}function ue(){try{t.texStorage2D(...arguments)}catch(D){et("WebGLState:",D)}}function de(){try{t.texStorage3D(...arguments)}catch(D){et("WebGLState:",D)}}function ne(){try{t.texImage2D(...arguments)}catch(D){et("WebGLState:",D)}}function re(){try{t.texImage3D(...arguments)}catch(D){et("WebGLState:",D)}}function me(D){return m[D]!==void 0?m[D]:t.getParameter(D)}function Le(D,he){m[D]!==he&&(t.pixelStorei(D,he),m[D]=he)}function _e(D){oe.equals(D)===!1&&(t.scissor(D.x,D.y,D.z,D.w),oe.copy(D))}function ge(D){se.equals(D)===!1&&(t.viewport(D.x,D.y,D.z,D.w),se.copy(D))}function Fe(D,he){let ie=c.get(he);ie===void 0&&(ie=new WeakMap,c.set(he,ie));let xe=ie.get(D);xe===void 0&&(xe=t.getUniformBlockIndex(he,D.name),ie.set(D,xe))}function ke(D,he){const xe=c.get(he).get(D);l.get(he)!==xe&&(t.uniformBlockBinding(he,xe,D.__bindingPointIndex),l.set(he,xe))}function Ge(){t.disable(t.BLEND),t.disable(t.CULL_FACE),t.disable(t.DEPTH_TEST),t.disable(t.POLYGON_OFFSET_FILL),t.disable(t.SCISSOR_TEST),t.disable(t.STENCIL_TEST),t.disable(t.SAMPLE_ALPHA_TO_COVERAGE),t.blendEquation(t.FUNC_ADD),t.blendFunc(t.ONE,t.ZERO),t.blendFuncSeparate(t.ONE,t.ZERO,t.ONE,t.ZERO),t.blendColor(0,0,0,0),t.colorMask(!0,!0,!0,!0),t.clearColor(0,0,0,0),t.depthMask(!0),t.depthFunc(t.LESS),a.setReversed(!1),t.clearDepth(1),t.stencilMask(4294967295),t.stencilFunc(t.ALWAYS,0,4294967295),t.stencilOp(t.KEEP,t.KEEP,t.KEEP),t.clearStencil(0),t.cullFace(t.BACK),t.frontFace(t.CCW),t.polygonOffset(0,0),t.activeTexture(t.TEXTURE0),t.bindFramebuffer(t.FRAMEBUFFER,null),t.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),t.bindFramebuffer(t.READ_FRAMEBUFFER,null),t.useProgram(null),t.lineWidth(1),t.scissor(0,0,t.canvas.width,t.canvas.height),t.viewport(0,0,t.canvas.width,t.canvas.height),t.pixelStorei(t.PACK_ALIGNMENT,4),t.pixelStorei(t.UNPACK_ALIGNMENT,4),t.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,!1),t.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),t.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,t.BROWSER_DEFAULT_WEBGL),t.pixelStorei(t.PACK_ROW_LENGTH,0),t.pixelStorei(t.PACK_SKIP_PIXELS,0),t.pixelStorei(t.PACK_SKIP_ROWS,0),t.pixelStorei(t.UNPACK_ROW_LENGTH,0),t.pixelStorei(t.UNPACK_IMAGE_HEIGHT,0),t.pixelStorei(t.UNPACK_SKIP_PIXELS,0),t.pixelStorei(t.UNPACK_SKIP_ROWS,0),t.pixelStorei(t.UNPACK_SKIP_IMAGES,0),p={},m={},P=null,C={},u={},f=new WeakMap,y=[],E=null,x=!1,d=null,g=null,v=null,M=null,T=null,w=null,R=null,_=new Ze(0,0,0),A=0,I=!1,L=null,B=null,G=null,Q=null,k=null,oe.set(0,0,t.canvas.width,t.canvas.height),se.set(0,0,t.canvas.width,t.canvas.height),s.reset(),a.reset(),o.reset()}return{buffers:{color:s,depth:a,stencil:o},enable:ee,disable:pe,bindFramebuffer:Ee,drawBuffers:fe,useProgram:ve,setBlending:ze,setMaterial:Ve,setFlipSided:nt,setCullFace:st,setLineWidth:ft,setPolygonOffset:lt,setScissorTest:vt,activeTexture:Et,bindTexture:U,unbindTexture:Vt,compressedTexImage2D:it,compressedTexImage3D:N,texImage2D:ne,texImage3D:re,pixelStorei:Le,getParameter:me,updateUBOMapping:Fe,uniformBlockBinding:ke,texStorage2D:ue,texStorage3D:de,texSubImage2D:S,texSubImage3D:z,compressedTexSubImage2D:$,compressedTexSubImage3D:te,scissor:_e,viewport:ge,reset:Ge}}function _T(t,e,n,i,r,s,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Qe,p=new WeakMap,m=new Set;let u;const f=new WeakMap;let y=!1;try{y=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function E(N,S){return y?new OffscreenCanvas(N,S):Pl("canvas")}function x(N,S,z){let $=1;const te=it(N);if((te.width>z||te.height>z)&&($=z/Math.max(te.width,te.height)),$<1)if(typeof HTMLImageElement<"u"&&N instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&N instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&N instanceof ImageBitmap||typeof VideoFrame<"u"&&N instanceof VideoFrame){const ue=Math.floor($*te.width),de=Math.floor($*te.height);u===void 0&&(u=E(ue,de));const ne=S?E(ue,de):u;return ne.width=ue,ne.height=de,ne.getContext("2d").drawImage(N,0,0,ue,de),Oe("WebGLRenderer: Texture has been resized from ("+te.width+"x"+te.height+") to ("+ue+"x"+de+")."),ne}else return"data"in N&&Oe("WebGLRenderer: Image in DataTexture is too big ("+te.width+"x"+te.height+")."),N;return N}function d(N){return N.generateMipmaps}function g(N){t.generateMipmap(N)}function v(N){return N.isWebGLCubeRenderTarget?t.TEXTURE_CUBE_MAP:N.isWebGL3DRenderTarget?t.TEXTURE_3D:N.isWebGLArrayRenderTarget||N.isCompressedArrayTexture?t.TEXTURE_2D_ARRAY:t.TEXTURE_2D}function M(N,S,z,$,te,ue=!1){if(N!==null){if(t[N]!==void 0)return t[N];Oe("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+N+"'")}let de;$&&(de=e.get("EXT_texture_norm16"),de||Oe("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let ne=S;if(S===t.RED&&(z===t.FLOAT&&(ne=t.R32F),z===t.HALF_FLOAT&&(ne=t.R16F),z===t.UNSIGNED_BYTE&&(ne=t.R8),z===t.UNSIGNED_SHORT&&de&&(ne=de.R16_EXT),z===t.SHORT&&de&&(ne=de.R16_SNORM_EXT)),S===t.RED_INTEGER&&(z===t.UNSIGNED_BYTE&&(ne=t.R8UI),z===t.UNSIGNED_SHORT&&(ne=t.R16UI),z===t.UNSIGNED_INT&&(ne=t.R32UI),z===t.BYTE&&(ne=t.R8I),z===t.SHORT&&(ne=t.R16I),z===t.INT&&(ne=t.R32I)),S===t.RG&&(z===t.FLOAT&&(ne=t.RG32F),z===t.HALF_FLOAT&&(ne=t.RG16F),z===t.UNSIGNED_BYTE&&(ne=t.RG8),z===t.UNSIGNED_SHORT&&de&&(ne=de.RG16_EXT),z===t.SHORT&&de&&(ne=de.RG16_SNORM_EXT)),S===t.RG_INTEGER&&(z===t.UNSIGNED_BYTE&&(ne=t.RG8UI),z===t.UNSIGNED_SHORT&&(ne=t.RG16UI),z===t.UNSIGNED_INT&&(ne=t.RG32UI),z===t.BYTE&&(ne=t.RG8I),z===t.SHORT&&(ne=t.RG16I),z===t.INT&&(ne=t.RG32I)),S===t.RGB_INTEGER&&(z===t.UNSIGNED_BYTE&&(ne=t.RGB8UI),z===t.UNSIGNED_SHORT&&(ne=t.RGB16UI),z===t.UNSIGNED_INT&&(ne=t.RGB32UI),z===t.BYTE&&(ne=t.RGB8I),z===t.SHORT&&(ne=t.RGB16I),z===t.INT&&(ne=t.RGB32I)),S===t.RGBA_INTEGER&&(z===t.UNSIGNED_BYTE&&(ne=t.RGBA8UI),z===t.UNSIGNED_SHORT&&(ne=t.RGBA16UI),z===t.UNSIGNED_INT&&(ne=t.RGBA32UI),z===t.BYTE&&(ne=t.RGBA8I),z===t.SHORT&&(ne=t.RGBA16I),z===t.INT&&(ne=t.RGBA32I)),S===t.RGB&&(z===t.UNSIGNED_SHORT&&de&&(ne=de.RGB16_EXT),z===t.SHORT&&de&&(ne=de.RGB16_SNORM_EXT),z===t.UNSIGNED_INT_5_9_9_9_REV&&(ne=t.RGB9_E5),z===t.UNSIGNED_INT_10F_11F_11F_REV&&(ne=t.R11F_G11F_B10F)),S===t.RGBA){const re=ue?Rl:$e.getTransfer(te);z===t.FLOAT&&(ne=t.RGBA32F),z===t.HALF_FLOAT&&(ne=t.RGBA16F),z===t.UNSIGNED_BYTE&&(ne=re===at?t.SRGB8_ALPHA8:t.RGBA8),z===t.UNSIGNED_SHORT&&de&&(ne=de.RGBA16_EXT),z===t.SHORT&&de&&(ne=de.RGBA16_SNORM_EXT),z===t.UNSIGNED_SHORT_4_4_4_4&&(ne=t.RGBA4),z===t.UNSIGNED_SHORT_5_5_5_1&&(ne=t.RGB5_A1)}return(ne===t.R16F||ne===t.R32F||ne===t.RG16F||ne===t.RG32F||ne===t.RGBA16F||ne===t.RGBA32F)&&e.get("EXT_color_buffer_float"),ne}function T(N,S){let z;return N?S===null||S===fi||S===ka?z=t.DEPTH24_STENCIL8:S===ai?z=t.DEPTH32F_STENCIL8:S===Fa&&(z=t.DEPTH24_STENCIL8,Oe("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):S===null||S===fi||S===ka?z=t.DEPTH_COMPONENT24:S===ai?z=t.DEPTH_COMPONENT32F:S===Fa&&(z=t.DEPTH_COMPONENT16),z}function w(N,S){return d(N)===!0||N.isFramebufferTexture&&N.minFilter!==Gt&&N.minFilter!==Qt?Math.log2(Math.max(S.width,S.height))+1:N.mipmaps!==void 0&&N.mipmaps.length>0?N.mipmaps.length:N.isCompressedTexture&&Array.isArray(N.image)?S.mipmaps.length:1}function R(N){const S=N.target;S.removeEventListener("dispose",R),A(S),S.isVideoTexture&&p.delete(S),S.isHTMLTexture&&m.delete(S)}function _(N){const S=N.target;S.removeEventListener("dispose",_),L(S)}function A(N){const S=i.get(N);if(S.__webglInit===void 0)return;const z=N.source,$=f.get(z);if($){const te=$[S.__cacheKey];te.usedTimes--,te.usedTimes===0&&I(N),Object.keys($).length===0&&f.delete(z)}i.remove(N)}function I(N){const S=i.get(N);t.deleteTexture(S.__webglTexture);const z=N.source,$=f.get(z);delete $[S.__cacheKey],a.memory.textures--}function L(N){const S=i.get(N);if(N.depthTexture&&(N.depthTexture.dispose(),i.remove(N.depthTexture)),N.isWebGLCubeRenderTarget)for(let $=0;$<6;$++){if(Array.isArray(S.__webglFramebuffer[$]))for(let te=0;te<S.__webglFramebuffer[$].length;te++)t.deleteFramebuffer(S.__webglFramebuffer[$][te]);else t.deleteFramebuffer(S.__webglFramebuffer[$]);S.__webglDepthbuffer&&t.deleteRenderbuffer(S.__webglDepthbuffer[$])}else{if(Array.isArray(S.__webglFramebuffer))for(let $=0;$<S.__webglFramebuffer.length;$++)t.deleteFramebuffer(S.__webglFramebuffer[$]);else t.deleteFramebuffer(S.__webglFramebuffer);if(S.__webglDepthbuffer&&t.deleteRenderbuffer(S.__webglDepthbuffer),S.__webglMultisampledFramebuffer&&t.deleteFramebuffer(S.__webglMultisampledFramebuffer),S.__webglColorRenderbuffer)for(let $=0;$<S.__webglColorRenderbuffer.length;$++)S.__webglColorRenderbuffer[$]&&t.deleteRenderbuffer(S.__webglColorRenderbuffer[$]);S.__webglDepthRenderbuffer&&t.deleteRenderbuffer(S.__webglDepthRenderbuffer)}const z=N.textures;for(let $=0,te=z.length;$<te;$++){const ue=i.get(z[$]);ue.__webglTexture&&(t.deleteTexture(ue.__webglTexture),a.memory.textures--),i.remove(z[$])}i.remove(N)}let B=0;function G(){B=0}function Q(){return B}function k(N){B=N}function Y(){const N=B;return N>=r.maxTextures&&Oe("WebGLTextures: Trying to use "+N+" texture units while this GPU supports only "+r.maxTextures),B+=1,N}function W(N){const S=[];return S.push(N.wrapS),S.push(N.wrapT),S.push(N.wrapR||0),S.push(N.magFilter),S.push(N.minFilter),S.push(N.anisotropy),S.push(N.internalFormat),S.push(N.format),S.push(N.type),S.push(N.generateMipmaps),S.push(N.premultiplyAlpha),S.push(N.flipY),S.push(N.unpackAlignment),S.push(N.colorSpace),S.join()}function F(N,S){const z=i.get(N);if(N.isVideoTexture&&U(N),N.isRenderTargetTexture===!1&&N.isExternalTexture!==!0&&N.version>0&&z.__version!==N.version){const $=N.image;if($===null)Oe("WebGLRenderer: Texture marked for update but no image data found.");else if($.complete===!1)Oe("WebGLRenderer: Texture marked for update but image is incomplete");else{pe(z,N,S);return}}else N.isExternalTexture&&(z.__webglTexture=N.sourceTexture?N.sourceTexture:null);n.bindTexture(t.TEXTURE_2D,z.__webglTexture,t.TEXTURE0+S)}function Z(N,S){const z=i.get(N);if(N.isRenderTargetTexture===!1&&N.version>0&&z.__version!==N.version){pe(z,N,S);return}else N.isExternalTexture&&(z.__webglTexture=N.sourceTexture?N.sourceTexture:null);n.bindTexture(t.TEXTURE_2D_ARRAY,z.__webglTexture,t.TEXTURE0+S)}function P(N,S){const z=i.get(N);if(N.isRenderTargetTexture===!1&&N.version>0&&z.__version!==N.version){pe(z,N,S);return}n.bindTexture(t.TEXTURE_3D,z.__webglTexture,t.TEXTURE0+S)}function C(N,S){const z=i.get(N);if(N.isCubeDepthTexture!==!0&&N.version>0&&z.__version!==N.version){Ee(z,N,S);return}n.bindTexture(t.TEXTURE_CUBE_MAP,z.__webglTexture,t.TEXTURE0+S)}const V={[pd]:t.REPEAT,[bi]:t.CLAMP_TO_EDGE,[md]:t.MIRRORED_REPEAT},ae={[Gt]:t.NEAREST,[BS]:t.NEAREST_MIPMAP_NEAREST,[ho]:t.NEAREST_MIPMAP_LINEAR,[Qt]:t.LINEAR,[Lc]:t.LINEAR_MIPMAP_NEAREST,[Tr]:t.LINEAR_MIPMAP_LINEAR},oe={[HS]:t.NEVER,[qS]:t.ALWAYS,[GS]:t.LESS,[nh]:t.LEQUAL,[WS]:t.EQUAL,[ih]:t.GEQUAL,[jS]:t.GREATER,[XS]:t.NOTEQUAL};function se(N,S){if(S.type===ai&&e.has("OES_texture_float_linear")===!1&&(S.magFilter===Qt||S.magFilter===Lc||S.magFilter===ho||S.magFilter===Tr||S.minFilter===Qt||S.minFilter===Lc||S.minFilter===ho||S.minFilter===Tr)&&Oe("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),t.texParameteri(N,t.TEXTURE_WRAP_S,V[S.wrapS]),t.texParameteri(N,t.TEXTURE_WRAP_T,V[S.wrapT]),(N===t.TEXTURE_3D||N===t.TEXTURE_2D_ARRAY)&&t.texParameteri(N,t.TEXTURE_WRAP_R,V[S.wrapR]),t.texParameteri(N,t.TEXTURE_MAG_FILTER,ae[S.magFilter]),t.texParameteri(N,t.TEXTURE_MIN_FILTER,ae[S.minFilter]),S.compareFunction&&(t.texParameteri(N,t.TEXTURE_COMPARE_MODE,t.COMPARE_REF_TO_TEXTURE),t.texParameteri(N,t.TEXTURE_COMPARE_FUNC,oe[S.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(S.magFilter===Gt||S.minFilter!==ho&&S.minFilter!==Tr||S.type===ai&&e.has("OES_texture_float_linear")===!1)return;if(S.anisotropy>1||i.get(S).__currentAnisotropy){const z=e.get("EXT_texture_filter_anisotropic");t.texParameterf(N,z.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(S.anisotropy,r.getMaxAnisotropy())),i.get(S).__currentAnisotropy=S.anisotropy}}}function H(N,S){let z=!1;N.__webglInit===void 0&&(N.__webglInit=!0,S.addEventListener("dispose",R));const $=S.source;let te=f.get($);te===void 0&&(te={},f.set($,te));const ue=W(S);if(ue!==N.__cacheKey){te[ue]===void 0&&(te[ue]={texture:t.createTexture(),usedTimes:0},a.memory.textures++,z=!0),te[ue].usedTimes++;const de=te[N.__cacheKey];de!==void 0&&(te[N.__cacheKey].usedTimes--,de.usedTimes===0&&I(S)),N.__cacheKey=ue,N.__webglTexture=te[ue].texture}return z}function J(N,S,z){return Math.floor(Math.floor(N/z)/S)}function ee(N,S,z,$){const ue=N.updateRanges;if(ue.length===0)n.texSubImage2D(t.TEXTURE_2D,0,0,0,S.width,S.height,z,$,S.data);else{ue.sort((Le,_e)=>Le.start-_e.start);let de=0;for(let Le=1;Le<ue.length;Le++){const _e=ue[de],ge=ue[Le],Fe=_e.start+_e.count,ke=J(ge.start,S.width,4),Ge=J(_e.start,S.width,4);ge.start<=Fe+1&&ke===Ge&&J(ge.start+ge.count-1,S.width,4)===ke?_e.count=Math.max(_e.count,ge.start+ge.count-_e.start):(++de,ue[de]=ge)}ue.length=de+1;const ne=n.getParameter(t.UNPACK_ROW_LENGTH),re=n.getParameter(t.UNPACK_SKIP_PIXELS),me=n.getParameter(t.UNPACK_SKIP_ROWS);n.pixelStorei(t.UNPACK_ROW_LENGTH,S.width);for(let Le=0,_e=ue.length;Le<_e;Le++){const ge=ue[Le],Fe=Math.floor(ge.start/4),ke=Math.ceil(ge.count/4),Ge=Fe%S.width,D=Math.floor(Fe/S.width),he=ke,ie=1;n.pixelStorei(t.UNPACK_SKIP_PIXELS,Ge),n.pixelStorei(t.UNPACK_SKIP_ROWS,D),n.texSubImage2D(t.TEXTURE_2D,0,Ge,D,he,ie,z,$,S.data)}N.clearUpdateRanges(),n.pixelStorei(t.UNPACK_ROW_LENGTH,ne),n.pixelStorei(t.UNPACK_SKIP_PIXELS,re),n.pixelStorei(t.UNPACK_SKIP_ROWS,me)}}function pe(N,S,z){let $=t.TEXTURE_2D;(S.isDataArrayTexture||S.isCompressedArrayTexture)&&($=t.TEXTURE_2D_ARRAY),S.isData3DTexture&&($=t.TEXTURE_3D);const te=H(N,S),ue=S.source;n.bindTexture($,N.__webglTexture,t.TEXTURE0+z);const de=i.get(ue);if(ue.version!==de.__version||te===!0){if(n.activeTexture(t.TEXTURE0+z),(typeof ImageBitmap<"u"&&S.image instanceof ImageBitmap)===!1){const ie=$e.getPrimaries($e.workingColorSpace),xe=S.colorSpace===Yi?null:$e.getPrimaries(S.colorSpace),be=S.colorSpace===Yi||ie===xe?t.NONE:t.BROWSER_DEFAULT_WEBGL;n.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,S.flipY),n.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,S.premultiplyAlpha),n.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,be)}n.pixelStorei(t.UNPACK_ALIGNMENT,S.unpackAlignment);let re=x(S.image,!1,r.maxTextureSize);re=Vt(S,re);const me=s.convert(S.format,S.colorSpace),Le=s.convert(S.type);let _e=M(S.internalFormat,me,Le,S.normalized,S.colorSpace,S.isVideoTexture);se($,S);let ge;const Fe=S.mipmaps,ke=S.isVideoTexture!==!0,Ge=de.__version===void 0||te===!0,D=ue.dataReady,he=w(S,re);if(S.isDepthTexture)_e=T(S.format===Ar,S.type),Ge&&(ke?n.texStorage2D(t.TEXTURE_2D,1,_e,re.width,re.height):n.texImage2D(t.TEXTURE_2D,0,_e,re.width,re.height,0,me,Le,null));else if(S.isDataTexture)if(Fe.length>0){ke&&Ge&&n.texStorage2D(t.TEXTURE_2D,he,_e,Fe[0].width,Fe[0].height);for(let ie=0,xe=Fe.length;ie<xe;ie++)ge=Fe[ie],ke?D&&n.texSubImage2D(t.TEXTURE_2D,ie,0,0,ge.width,ge.height,me,Le,ge.data):n.texImage2D(t.TEXTURE_2D,ie,_e,ge.width,ge.height,0,me,Le,ge.data);S.generateMipmaps=!1}else ke?(Ge&&n.texStorage2D(t.TEXTURE_2D,he,_e,re.width,re.height),D&&ee(S,re,me,Le)):n.texImage2D(t.TEXTURE_2D,0,_e,re.width,re.height,0,me,Le,re.data);else if(S.isCompressedTexture)if(S.isCompressedArrayTexture){ke&&Ge&&n.texStorage3D(t.TEXTURE_2D_ARRAY,he,_e,Fe[0].width,Fe[0].height,re.depth);for(let ie=0,xe=Fe.length;ie<xe;ie++)if(ge=Fe[ie],S.format!==qn)if(me!==null)if(ke){if(D)if(S.layerUpdates.size>0){const be=am(ge.width,ge.height,S.format,S.type);for(const le of S.layerUpdates){const Ie=ge.data.subarray(le*be/ge.data.BYTES_PER_ELEMENT,(le+1)*be/ge.data.BYTES_PER_ELEMENT);n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,ie,0,0,le,ge.width,ge.height,1,me,Ie)}S.clearLayerUpdates()}else n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,ie,0,0,0,ge.width,ge.height,re.depth,me,ge.data)}else n.compressedTexImage3D(t.TEXTURE_2D_ARRAY,ie,_e,ge.width,ge.height,re.depth,0,ge.data,0,0);else Oe("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else ke?D&&n.texSubImage3D(t.TEXTURE_2D_ARRAY,ie,0,0,0,ge.width,ge.height,re.depth,me,Le,ge.data):n.texImage3D(t.TEXTURE_2D_ARRAY,ie,_e,ge.width,ge.height,re.depth,0,me,Le,ge.data)}else{ke&&Ge&&n.texStorage2D(t.TEXTURE_2D,he,_e,Fe[0].width,Fe[0].height);for(let ie=0,xe=Fe.length;ie<xe;ie++)ge=Fe[ie],S.format!==qn?me!==null?ke?D&&n.compressedTexSubImage2D(t.TEXTURE_2D,ie,0,0,ge.width,ge.height,me,ge.data):n.compressedTexImage2D(t.TEXTURE_2D,ie,_e,ge.width,ge.height,0,ge.data):Oe("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):ke?D&&n.texSubImage2D(t.TEXTURE_2D,ie,0,0,ge.width,ge.height,me,Le,ge.data):n.texImage2D(t.TEXTURE_2D,ie,_e,ge.width,ge.height,0,me,Le,ge.data)}else if(S.isDataArrayTexture)if(ke){if(Ge&&n.texStorage3D(t.TEXTURE_2D_ARRAY,he,_e,re.width,re.height,re.depth),D)if(S.layerUpdates.size>0){const ie=am(re.width,re.height,S.format,S.type);for(const xe of S.layerUpdates){const be=re.data.subarray(xe*ie/re.data.BYTES_PER_ELEMENT,(xe+1)*ie/re.data.BYTES_PER_ELEMENT);n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,xe,re.width,re.height,1,me,Le,be)}S.clearLayerUpdates()}else n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,0,re.width,re.height,re.depth,me,Le,re.data)}else n.texImage3D(t.TEXTURE_2D_ARRAY,0,_e,re.width,re.height,re.depth,0,me,Le,re.data);else if(S.isData3DTexture)ke?(Ge&&n.texStorage3D(t.TEXTURE_3D,he,_e,re.width,re.height,re.depth),D&&n.texSubImage3D(t.TEXTURE_3D,0,0,0,0,re.width,re.height,re.depth,me,Le,re.data)):n.texImage3D(t.TEXTURE_3D,0,_e,re.width,re.height,re.depth,0,me,Le,re.data);else if(S.isFramebufferTexture){if(Ge)if(ke)n.texStorage2D(t.TEXTURE_2D,he,_e,re.width,re.height);else{let ie=re.width,xe=re.height;for(let be=0;be<he;be++)n.texImage2D(t.TEXTURE_2D,be,_e,ie,xe,0,me,Le,null),ie>>=1,xe>>=1}}else if(S.isHTMLTexture){if("texElementImage2D"in t){const ie=t.canvas;if(ie.hasAttribute("layoutsubtree")||ie.setAttribute("layoutsubtree","true"),re.parentNode!==ie){ie.appendChild(re),m.add(S),ie.onpaint=xe=>{const be=xe.changedElements;for(const le of m)be.includes(le.image)&&(le.needsUpdate=!0)},ie.requestPaint();return}if(t.texElementImage2D.length===3)t.texElementImage2D(t.TEXTURE_2D,t.RGBA8,re);else{const be=t.RGBA,le=t.RGBA,Ie=t.UNSIGNED_BYTE;t.texElementImage2D(t.TEXTURE_2D,0,be,le,Ie,re)}t.texParameteri(t.TEXTURE_2D,t.TEXTURE_MIN_FILTER,t.LINEAR),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_WRAP_S,t.CLAMP_TO_EDGE),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_WRAP_T,t.CLAMP_TO_EDGE)}}else if(Fe.length>0){if(ke&&Ge){const ie=it(Fe[0]);n.texStorage2D(t.TEXTURE_2D,he,_e,ie.width,ie.height)}for(let ie=0,xe=Fe.length;ie<xe;ie++)ge=Fe[ie],ke?D&&n.texSubImage2D(t.TEXTURE_2D,ie,0,0,me,Le,ge):n.texImage2D(t.TEXTURE_2D,ie,_e,me,Le,ge);S.generateMipmaps=!1}else if(ke){if(Ge){const ie=it(re);n.texStorage2D(t.TEXTURE_2D,he,_e,ie.width,ie.height)}D&&n.texSubImage2D(t.TEXTURE_2D,0,0,0,me,Le,re)}else n.texImage2D(t.TEXTURE_2D,0,_e,me,Le,re);d(S)&&g($),de.__version=ue.version,S.onUpdate&&S.onUpdate(S)}N.__version=S.version}function Ee(N,S,z){if(S.image.length!==6)return;const $=H(N,S),te=S.source;n.bindTexture(t.TEXTURE_CUBE_MAP,N.__webglTexture,t.TEXTURE0+z);const ue=i.get(te);if(te.version!==ue.__version||$===!0){n.activeTexture(t.TEXTURE0+z);const de=$e.getPrimaries($e.workingColorSpace),ne=S.colorSpace===Yi?null:$e.getPrimaries(S.colorSpace),re=S.colorSpace===Yi||de===ne?t.NONE:t.BROWSER_DEFAULT_WEBGL;n.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,S.flipY),n.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,S.premultiplyAlpha),n.pixelStorei(t.UNPACK_ALIGNMENT,S.unpackAlignment),n.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,re);const me=S.isCompressedTexture||S.image[0].isCompressedTexture,Le=S.image[0]&&S.image[0].isDataTexture,_e=[];for(let le=0;le<6;le++)!me&&!Le?_e[le]=x(S.image[le],!0,r.maxCubemapSize):_e[le]=Le?S.image[le].image:S.image[le],_e[le]=Vt(S,_e[le]);const ge=_e[0],Fe=s.convert(S.format,S.colorSpace),ke=s.convert(S.type),Ge=M(S.internalFormat,Fe,ke,S.normalized,S.colorSpace),D=S.isVideoTexture!==!0,he=ue.__version===void 0||$===!0,ie=te.dataReady;let xe=w(S,ge);se(t.TEXTURE_CUBE_MAP,S);let be;if(me){D&&he&&n.texStorage2D(t.TEXTURE_CUBE_MAP,xe,Ge,ge.width,ge.height);for(let le=0;le<6;le++){be=_e[le].mipmaps;for(let Ie=0;Ie<be.length;Ie++){const Ne=be[Ie];S.format!==qn?Fe!==null?D?ie&&n.compressedTexSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+le,Ie,0,0,Ne.width,Ne.height,Fe,Ne.data):n.compressedTexImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+le,Ie,Ge,Ne.width,Ne.height,0,Ne.data):Oe("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):D?ie&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+le,Ie,0,0,Ne.width,Ne.height,Fe,ke,Ne.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+le,Ie,Ge,Ne.width,Ne.height,0,Fe,ke,Ne.data)}}}else{if(be=S.mipmaps,D&&he){be.length>0&&xe++;const le=it(_e[0]);n.texStorage2D(t.TEXTURE_CUBE_MAP,xe,Ge,le.width,le.height)}for(let le=0;le<6;le++)if(Le){D?ie&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+le,0,0,0,_e[le].width,_e[le].height,Fe,ke,_e[le].data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+le,0,Ge,_e[le].width,_e[le].height,0,Fe,ke,_e[le].data);for(let Ie=0;Ie<be.length;Ie++){const bt=be[Ie].image[le].image;D?ie&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+le,Ie+1,0,0,bt.width,bt.height,Fe,ke,bt.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+le,Ie+1,Ge,bt.width,bt.height,0,Fe,ke,bt.data)}}else{D?ie&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+le,0,0,0,Fe,ke,_e[le]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+le,0,Ge,Fe,ke,_e[le]);for(let Ie=0;Ie<be.length;Ie++){const Ne=be[Ie];D?ie&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+le,Ie+1,0,0,Fe,ke,Ne.image[le]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+le,Ie+1,Ge,Fe,ke,Ne.image[le])}}}d(S)&&g(t.TEXTURE_CUBE_MAP),ue.__version=te.version,S.onUpdate&&S.onUpdate(S)}N.__version=S.version}function fe(N,S,z,$,te,ue){const de=s.convert(z.format,z.colorSpace),ne=s.convert(z.type),re=M(z.internalFormat,de,ne,z.normalized,z.colorSpace),me=i.get(S),Le=i.get(z);if(Le.__renderTarget=S,!me.__hasExternalTextures){const _e=Math.max(1,S.width>>ue),ge=Math.max(1,S.height>>ue);te===t.TEXTURE_3D||te===t.TEXTURE_2D_ARRAY?n.texImage3D(te,ue,re,_e,ge,S.depth,0,de,ne,null):n.texImage2D(te,ue,re,_e,ge,0,de,ne,null)}n.bindFramebuffer(t.FRAMEBUFFER,N),Et(S)?o.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,$,te,Le.__webglTexture,0,vt(S)):(te===t.TEXTURE_2D||te>=t.TEXTURE_CUBE_MAP_POSITIVE_X&&te<=t.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&t.framebufferTexture2D(t.FRAMEBUFFER,$,te,Le.__webglTexture,ue),n.bindFramebuffer(t.FRAMEBUFFER,null)}function ve(N,S,z){if(t.bindRenderbuffer(t.RENDERBUFFER,N),S.depthBuffer){const $=S.depthTexture,te=$&&$.isDepthTexture?$.type:null,ue=T(S.stencilBuffer,te),de=S.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;Et(S)?o.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,vt(S),ue,S.width,S.height):z?t.renderbufferStorageMultisample(t.RENDERBUFFER,vt(S),ue,S.width,S.height):t.renderbufferStorage(t.RENDERBUFFER,ue,S.width,S.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,de,t.RENDERBUFFER,N)}else{const $=S.textures;for(let te=0;te<$.length;te++){const ue=$[te],de=s.convert(ue.format,ue.colorSpace),ne=s.convert(ue.type),re=M(ue.internalFormat,de,ne,ue.normalized,ue.colorSpace);Et(S)?o.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,vt(S),re,S.width,S.height):z?t.renderbufferStorageMultisample(t.RENDERBUFFER,vt(S),re,S.width,S.height):t.renderbufferStorage(t.RENDERBUFFER,re,S.width,S.height)}}t.bindRenderbuffer(t.RENDERBUFFER,null)}function Re(N,S,z){const $=S.isWebGLCubeRenderTarget===!0;if(n.bindFramebuffer(t.FRAMEBUFFER,N),!(S.depthTexture&&S.depthTexture.isDepthTexture))throw new Error("THREE.WebGLTextures: renderTarget.depthTexture must be an instance of THREE.DepthTexture.");const te=i.get(S.depthTexture);if(te.__renderTarget=S,(!te.__webglTexture||S.depthTexture.image.width!==S.width||S.depthTexture.image.height!==S.height)&&(S.depthTexture.image.width=S.width,S.depthTexture.image.height=S.height,S.depthTexture.needsUpdate=!0),$){if(te.__webglInit===void 0&&(te.__webglInit=!0,S.depthTexture.addEventListener("dispose",R)),te.__webglTexture===void 0){te.__webglTexture=t.createTexture(),n.bindTexture(t.TEXTURE_CUBE_MAP,te.__webglTexture),se(t.TEXTURE_CUBE_MAP,S.depthTexture);const me=s.convert(S.depthTexture.format),Le=s.convert(S.depthTexture.type);let _e;S.depthTexture.format===Li?_e=t.DEPTH_COMPONENT24:S.depthTexture.format===Ar&&(_e=t.DEPTH24_STENCIL8);for(let ge=0;ge<6;ge++)t.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ge,0,_e,S.width,S.height,0,me,Le,null)}}else F(S.depthTexture,0);const ue=te.__webglTexture,de=vt(S),ne=$?t.TEXTURE_CUBE_MAP_POSITIVE_X+z:t.TEXTURE_2D,re=S.depthTexture.format===Ar?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;if(S.depthTexture.format===Li)Et(S)?o.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,re,ne,ue,0,de):t.framebufferTexture2D(t.FRAMEBUFFER,re,ne,ue,0);else if(S.depthTexture.format===Ar)Et(S)?o.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,re,ne,ue,0,de):t.framebufferTexture2D(t.FRAMEBUFFER,re,ne,ue,0);else throw new Error("THREE.WebGLTextures: Unknown depthTexture format.")}function Ce(N){const S=i.get(N),z=N.isWebGLCubeRenderTarget===!0;if(S.__boundDepthTexture!==N.depthTexture){const $=N.depthTexture;if(S.__depthDisposeCallback&&S.__depthDisposeCallback(),$){const te=()=>{delete S.__boundDepthTexture,delete S.__depthDisposeCallback,$.removeEventListener("dispose",te)};$.addEventListener("dispose",te),S.__depthDisposeCallback=te}S.__boundDepthTexture=$}if(N.depthTexture&&!S.__autoAllocateDepthBuffer)if(z)for(let $=0;$<6;$++)Re(S.__webglFramebuffer[$],N,$);else{const $=N.texture.mipmaps;$&&$.length>0?Re(S.__webglFramebuffer[0],N,0):Re(S.__webglFramebuffer,N,0)}else if(z){S.__webglDepthbuffer=[];for(let $=0;$<6;$++)if(n.bindFramebuffer(t.FRAMEBUFFER,S.__webglFramebuffer[$]),S.__webglDepthbuffer[$]===void 0)S.__webglDepthbuffer[$]=t.createRenderbuffer(),ve(S.__webglDepthbuffer[$],N,!1);else{const te=N.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,ue=S.__webglDepthbuffer[$];t.bindRenderbuffer(t.RENDERBUFFER,ue),t.framebufferRenderbuffer(t.FRAMEBUFFER,te,t.RENDERBUFFER,ue)}}else{const $=N.texture.mipmaps;if($&&$.length>0?n.bindFramebuffer(t.FRAMEBUFFER,S.__webglFramebuffer[0]):n.bindFramebuffer(t.FRAMEBUFFER,S.__webglFramebuffer),S.__webglDepthbuffer===void 0)S.__webglDepthbuffer=t.createRenderbuffer(),ve(S.__webglDepthbuffer,N,!1);else{const te=N.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,ue=S.__webglDepthbuffer;t.bindRenderbuffer(t.RENDERBUFFER,ue),t.framebufferRenderbuffer(t.FRAMEBUFFER,te,t.RENDERBUFFER,ue)}}n.bindFramebuffer(t.FRAMEBUFFER,null)}function ze(N,S,z){const $=i.get(N);S!==void 0&&fe($.__webglFramebuffer,N,N.texture,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,0),z!==void 0&&Ce(N)}function Ve(N){const S=N.texture,z=i.get(N),$=i.get(S);N.addEventListener("dispose",_);const te=N.textures,ue=N.isWebGLCubeRenderTarget===!0,de=te.length>1;if(de||($.__webglTexture===void 0&&($.__webglTexture=t.createTexture()),$.__version=S.version,a.memory.textures++),ue){z.__webglFramebuffer=[];for(let ne=0;ne<6;ne++)if(S.mipmaps&&S.mipmaps.length>0){z.__webglFramebuffer[ne]=[];for(let re=0;re<S.mipmaps.length;re++)z.__webglFramebuffer[ne][re]=t.createFramebuffer()}else z.__webglFramebuffer[ne]=t.createFramebuffer()}else{if(S.mipmaps&&S.mipmaps.length>0){z.__webglFramebuffer=[];for(let ne=0;ne<S.mipmaps.length;ne++)z.__webglFramebuffer[ne]=t.createFramebuffer()}else z.__webglFramebuffer=t.createFramebuffer();if(de)for(let ne=0,re=te.length;ne<re;ne++){const me=i.get(te[ne]);me.__webglTexture===void 0&&(me.__webglTexture=t.createTexture(),a.memory.textures++)}if(N.samples>0&&Et(N)===!1){z.__webglMultisampledFramebuffer=t.createFramebuffer(),z.__webglColorRenderbuffer=[],n.bindFramebuffer(t.FRAMEBUFFER,z.__webglMultisampledFramebuffer);for(let ne=0;ne<te.length;ne++){const re=te[ne];z.__webglColorRenderbuffer[ne]=t.createRenderbuffer(),t.bindRenderbuffer(t.RENDERBUFFER,z.__webglColorRenderbuffer[ne]);const me=s.convert(re.format,re.colorSpace),Le=s.convert(re.type),_e=M(re.internalFormat,me,Le,re.normalized,re.colorSpace,N.isXRRenderTarget===!0),ge=vt(N);t.renderbufferStorageMultisample(t.RENDERBUFFER,ge,_e,N.width,N.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+ne,t.RENDERBUFFER,z.__webglColorRenderbuffer[ne])}t.bindRenderbuffer(t.RENDERBUFFER,null),N.depthBuffer&&(z.__webglDepthRenderbuffer=t.createRenderbuffer(),ve(z.__webglDepthRenderbuffer,N,!0)),n.bindFramebuffer(t.FRAMEBUFFER,null)}}if(ue){n.bindTexture(t.TEXTURE_CUBE_MAP,$.__webglTexture),se(t.TEXTURE_CUBE_MAP,S);for(let ne=0;ne<6;ne++)if(S.mipmaps&&S.mipmaps.length>0)for(let re=0;re<S.mipmaps.length;re++)fe(z.__webglFramebuffer[ne][re],N,S,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+ne,re);else fe(z.__webglFramebuffer[ne],N,S,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+ne,0);d(S)&&g(t.TEXTURE_CUBE_MAP),n.unbindTexture()}else if(de){for(let ne=0,re=te.length;ne<re;ne++){const me=te[ne],Le=i.get(me);let _e=t.TEXTURE_2D;(N.isWebGL3DRenderTarget||N.isWebGLArrayRenderTarget)&&(_e=N.isWebGL3DRenderTarget?t.TEXTURE_3D:t.TEXTURE_2D_ARRAY),n.bindTexture(_e,Le.__webglTexture),se(_e,me),fe(z.__webglFramebuffer,N,me,t.COLOR_ATTACHMENT0+ne,_e,0),d(me)&&g(_e)}n.unbindTexture()}else{let ne=t.TEXTURE_2D;if((N.isWebGL3DRenderTarget||N.isWebGLArrayRenderTarget)&&(ne=N.isWebGL3DRenderTarget?t.TEXTURE_3D:t.TEXTURE_2D_ARRAY),n.bindTexture(ne,$.__webglTexture),se(ne,S),S.mipmaps&&S.mipmaps.length>0)for(let re=0;re<S.mipmaps.length;re++)fe(z.__webglFramebuffer[re],N,S,t.COLOR_ATTACHMENT0,ne,re);else fe(z.__webglFramebuffer,N,S,t.COLOR_ATTACHMENT0,ne,0);d(S)&&g(ne),n.unbindTexture()}N.depthBuffer&&Ce(N)}function nt(N){const S=N.textures;for(let z=0,$=S.length;z<$;z++){const te=S[z];if(d(te)){const ue=v(N),de=i.get(te).__webglTexture;n.bindTexture(ue,de),g(ue),n.unbindTexture()}}}const st=[],ft=[];function lt(N){if(N.samples>0){if(Et(N)===!1){const S=N.textures,z=N.width,$=N.height;let te=t.COLOR_BUFFER_BIT;const ue=N.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,de=i.get(N),ne=S.length>1;if(ne)for(let me=0;me<S.length;me++)n.bindFramebuffer(t.FRAMEBUFFER,de.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+me,t.RENDERBUFFER,null),n.bindFramebuffer(t.FRAMEBUFFER,de.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+me,t.TEXTURE_2D,null,0);n.bindFramebuffer(t.READ_FRAMEBUFFER,de.__webglMultisampledFramebuffer);const re=N.texture.mipmaps;re&&re.length>0?n.bindFramebuffer(t.DRAW_FRAMEBUFFER,de.__webglFramebuffer[0]):n.bindFramebuffer(t.DRAW_FRAMEBUFFER,de.__webglFramebuffer);for(let me=0;me<S.length;me++){if(N.resolveDepthBuffer&&(N.depthBuffer&&(te|=t.DEPTH_BUFFER_BIT),N.stencilBuffer&&N.resolveStencilBuffer&&(te|=t.STENCIL_BUFFER_BIT)),ne){t.framebufferRenderbuffer(t.READ_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.RENDERBUFFER,de.__webglColorRenderbuffer[me]);const Le=i.get(S[me]).__webglTexture;t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,Le,0)}t.blitFramebuffer(0,0,z,$,0,0,z,$,te,t.NEAREST),l===!0&&(st.length=0,ft.length=0,st.push(t.COLOR_ATTACHMENT0+me),N.depthBuffer&&N.resolveDepthBuffer===!1&&(st.push(ue),ft.push(ue),t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,ft)),t.invalidateFramebuffer(t.READ_FRAMEBUFFER,st))}if(n.bindFramebuffer(t.READ_FRAMEBUFFER,null),n.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),ne)for(let me=0;me<S.length;me++){n.bindFramebuffer(t.FRAMEBUFFER,de.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+me,t.RENDERBUFFER,de.__webglColorRenderbuffer[me]);const Le=i.get(S[me]).__webglTexture;n.bindFramebuffer(t.FRAMEBUFFER,de.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+me,t.TEXTURE_2D,Le,0)}n.bindFramebuffer(t.DRAW_FRAMEBUFFER,de.__webglMultisampledFramebuffer)}else if(N.depthBuffer&&N.resolveDepthBuffer===!1&&l){const S=N.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,[S])}}}function vt(N){return Math.min(r.maxSamples,N.samples)}function Et(N){const S=i.get(N);return N.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&S.__useRenderToTexture!==!1}function U(N){const S=a.render.frame;p.get(N)!==S&&(p.set(N,S),N.update())}function Vt(N,S){const z=N.colorSpace,$=N.format,te=N.type;return N.isCompressedTexture===!0||N.isVideoTexture===!0||z!==Cl&&z!==Yi&&($e.getTransfer(z)===at?($!==qn||te!==In)&&Oe("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):et("WebGLTextures: Unsupported texture color space:",z)),S}function it(N){return typeof HTMLImageElement<"u"&&N instanceof HTMLImageElement?(c.width=N.naturalWidth||N.width,c.height=N.naturalHeight||N.height):typeof VideoFrame<"u"&&N instanceof VideoFrame?(c.width=N.displayWidth,c.height=N.displayHeight):(c.width=N.width,c.height=N.height),c}this.allocateTextureUnit=Y,this.resetTextureUnits=G,this.getTextureUnits=Q,this.setTextureUnits=k,this.setTexture2D=F,this.setTexture2DArray=Z,this.setTexture3D=P,this.setTextureCube=C,this.rebindTextures=ze,this.setupRenderTarget=Ve,this.updateRenderTargetMipmap=nt,this.updateMultisampleRenderTarget=lt,this.setupDepthRenderbuffer=Ce,this.setupFrameBufferTexture=fe,this.useMultisampledRTT=Et,this.isReversedDepthBuffer=function(){return n.buffers.depth.getReversed()}}function yT(t,e){function n(i,r=Yi){let s;const a=$e.getTransfer(r);if(i===In)return t.UNSIGNED_BYTE;if(i===Zf)return t.UNSIGNED_SHORT_4_4_4_4;if(i===Qf)return t.UNSIGNED_SHORT_5_5_5_1;if(i===cx)return t.UNSIGNED_INT_5_9_9_9_REV;if(i===ux)return t.UNSIGNED_INT_10F_11F_11F_REV;if(i===ox)return t.BYTE;if(i===lx)return t.SHORT;if(i===Fa)return t.UNSIGNED_SHORT;if(i===Kf)return t.INT;if(i===fi)return t.UNSIGNED_INT;if(i===ai)return t.FLOAT;if(i===Ii)return t.HALF_FLOAT;if(i===dx)return t.ALPHA;if(i===fx)return t.RGB;if(i===qn)return t.RGBA;if(i===Li)return t.DEPTH_COMPONENT;if(i===Ar)return t.DEPTH_STENCIL;if(i===hx)return t.RED;if(i===Jf)return t.RED_INTEGER;if(i===Fr)return t.RG;if(i===eh)return t.RG_INTEGER;if(i===th)return t.RGBA_INTEGER;if(i===Zo||i===Qo||i===Jo||i===el)if(a===at)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(i===Zo)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===Qo)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===Jo)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===el)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(i===Zo)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===Qo)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===Jo)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===el)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===gd||i===xd||i===vd||i===_d)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(i===gd)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===xd)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===vd)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===_d)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===yd||i===Sd||i===Md||i===Ed||i===bd||i===Tl||i===wd)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(i===yd||i===Sd)return a===at?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(i===Md)return a===at?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC;if(i===Ed)return s.COMPRESSED_R11_EAC;if(i===bd)return s.COMPRESSED_SIGNED_R11_EAC;if(i===Tl)return s.COMPRESSED_RG11_EAC;if(i===wd)return s.COMPRESSED_SIGNED_RG11_EAC}else return null;if(i===Td||i===Ad||i===Cd||i===Rd||i===Nd||i===Pd||i===Id||i===Ld||i===Dd||i===Ud||i===Fd||i===kd||i===Od||i===Bd)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(i===Td)return a===at?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===Ad)return a===at?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===Cd)return a===at?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===Rd)return a===at?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===Nd)return a===at?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===Pd)return a===at?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===Id)return a===at?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===Ld)return a===at?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===Dd)return a===at?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===Ud)return a===at?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===Fd)return a===at?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===kd)return a===at?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===Od)return a===at?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===Bd)return a===at?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===zd||i===Vd||i===Hd)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(i===zd)return a===at?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===Vd)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===Hd)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===Gd||i===Wd||i===Al||i===jd)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(i===Gd)return s.COMPRESSED_RED_RGTC1_EXT;if(i===Wd)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===Al)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===jd)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===ka?t.UNSIGNED_INT_24_8:t[i]!==void 0?t[i]:null}return{convert:n}}const ST=`
void main() {
